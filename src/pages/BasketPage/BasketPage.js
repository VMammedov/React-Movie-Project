...
const BasketPage = () => {
  return (
    ...
    <div className='p-3'>
      {JSON.parse(window.localStorage.getItem('data'))?JSON.parse(window.localStorage.getItem('data')).map((x)=>(<div className="accordion mt-2" id="accordionPanelsStayOpenExample">
